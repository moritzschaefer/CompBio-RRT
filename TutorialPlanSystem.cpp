...
void MyGaussian::generateGaussian(::rl::math::Vector& q2) {
	for (::std::size_t i = 0; i < this->model->getDof(); ++i)
	{
		q2(i) = this->gauss() * (*this->sigma)(i) + q2(i);
		//std::cout << "gauss:" << q2(i) << std::endl;
		if(i > 2 && q2(i) < -M_PI) {
			q2(i) += 2*M_PI;
		}
		if(i > 2 && q2(i) > M_PI) {
...
void
MyGaussian::generateCollisionFree(::rl::math::Vector& q)
{
...
void
MyGaussian::seed(const ::boost::mt19937::result_type& value)
{
